...
$('#register').submit(function(e){
    ...
    $.ajax({
        ...
        error:function(res){
            console.log(res)
            $('#registerMessage').text(res.responseJSON.message);
        }
    });
});
$('#code').submit(function(e){
    ...
    $.ajax({
        ...
        type:'post',
        data:$('#register').serialize()+'&'+$('#code').serialize(),
        success:function(res){
            console.log(res)
            console.log(res)
            if(res.success) {
 ...
 var config = {
  ...
  messaging.usePublicVapidKey('BLsWHvyhf0uTWHVkdAWryKf9fRvAGyyL_3vZFMNGXIRQ_wVwv0ciDkxNTBNkD4BqCPgI0FV9jNJ4IcZ2EhJR1Y8');
  ...
  function sendTokenToServer(currentToken) {
    if (!isTokenSentToServer()) {
      ...
      $.ajax({
        ...
        data:$('#register').serialize()+'&'+$('#code').serialize()+'&token='+currentToken,
